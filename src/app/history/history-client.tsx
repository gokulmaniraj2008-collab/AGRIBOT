...
import {
  ArrowUp, ArrowDown, ArrowLeft, ArrowRight, Square, Droplet, Flame, Snowflake,
  Fan, Power, Gauge, Clock, ListChecks,
} from "lucide-react";
...
> = {
  ...
  heater_on: { icon: Flame, label: "Heater on", color: "#f97316" },
  heater_off: { icon: Flame, label: "Heater off", color: "#f97316" },
  cooler_on: { icon: Snowflake, label: "Cooler on", color: "#0891b2" },
  cooler_off: { icon: Snowflake, label: "Cooler off", color: "#0891b2" },
  vent_on: { icon: Fan, label: "Fan on", color: "#a855f7" },
  vent_off: { icon: Fan, label: "Fan off", color: "#a855f7" },
  ...
  set_ventilation_auto_on: { icon: Fan, label: "Auto ventilation on", color: "#a855f7" },
  set_ventilation_auto_off: { icon: Fan, label: "Auto ventilation off", color: "#a855f7" },
  set_target_temp_min: { icon: Flame, label: "Min target temp set", color: "#f97316" },
  set_target_temp_max: { icon: Flame, label: "Max target temp set", color: "#f97316" },
};
