...
import {
  Droplets, Thermometer, Wind, Waves, FlaskConical, Leaf, Battery, Radar, MapPin,
} from "lucide-react";
import {
...
const METRICS: Metric[] = [
  ...
  {
    key: "ph_level", label: "pH Level", unit: "", icon: FlaskConical, color: "#a855f7", group: "soil",
    status: (v) => (v < 5.5 || v > 7.5 ? { label: "Out of range", tone: "warning" } : { label: "Good", tone: "success" }),
  },
  {
    key: "nitrogen", label: "Nitrogen (N)", unit: " mg/kg", icon: Leaf, color: "#16a34a", group: "soil",
    status: () => ({ label: "Tracked", tone: "success" }),
  },
  {
    key: "phosphorus", label: "Phosphorus (P)", unit: " mg/kg", icon: Leaf, color: "#0891b2", group: "soil",
    status: () => ({ label: "Tracked", tone: "success" }),
  },
  {
    key: "potassium", label: "Potassium (K)", unit: " mg/kg", icon: Leaf, color: "#ca8a04", group: "soil",
    status: () => ({ label: "Tracked", tone: "success" }),
  },
  {
  ...
  {
    key: "water_tank_percent", label: "Water Level", unit: "%", icon: Waves, color: "#0ea5e9", group: "climate",
