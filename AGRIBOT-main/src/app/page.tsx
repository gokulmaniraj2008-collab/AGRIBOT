...
export default function SplashPage() {
  ...
  return (
    <main className={`flex min-h-screen flex-col items-center justify-center bg-background px-6 transition-opacity duration-300 ${leaving ? "opacity-0" : "opacity-100"}`}>
      ...
      <p className="mt-3 animate-fade-in text-sm text-muted" style={{ animationDelay: "0.35s" }}>
