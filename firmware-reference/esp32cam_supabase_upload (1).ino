/*
  ...
  REQUIRES a DB migration adding "camera_check" to the
  robot_commands.command CHECK constraint before this will receive any
  requests — ask before applying that migration if you haven't yet.
...
const char* DEVICE_ID         = "agribot-01"; // used in filename + robot_id fields
